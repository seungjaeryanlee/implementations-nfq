...
def main():
    ...
    # Setup agent
    nfq_net = NFQNetwork()
    # NOTE(seungjaeryanlee): TF does not have Rprop
    ...
    for epoch in range(CONFIG.EPOCH + 1):
        ...
        if CONFIG.HINT_TO_GOAL:
            ...
            # TODO Modularize since uses TensorFlow
            state_action_b = tf.concat([state_action_b, goal_state_action_b], axis=0)
            target_q_values = tf.concat([target_q_values, goal_target_q_values], axis=0)
